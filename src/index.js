console.log(__dirname); // trả vê đường dẫn của file đâng đưungs hiện tại
console.log(process.cwd()); // Trả về đường dẫn gốc thu mục
const fs = require('fs') // => file system
// fs.writeFile(process.cwd() + "/text.txt", "Helo word", (err) => {
