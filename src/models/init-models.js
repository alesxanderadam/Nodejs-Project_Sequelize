...
const _Evaluate = require("./Evaluate");
...
function initModels(sequelize) {
  const Evaluate = _Evaluate(sequelize, DataTypes);
  ...
  Evaluate.belongsTo(restaurant, { as: "re", foreignKey: "res_id"});
  restaurant.hasMany(Evaluate, { as: "Evaluates", foreignKey: "res_id"});
  ...
  Evaluate.belongsTo(user, { as: "user", foreignKey: "user_id"});
  user.hasMany(Evaluate, { as: "Evaluates", foreignKey: "user_id"});
